...
- для тех, кто будет тестировать на windows. В проект установлена библиотека cross-env, в package.json в командах прописано cross-env BUG_ID, просто поменяйте значение этого параметра